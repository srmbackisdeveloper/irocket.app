    ...
    return (
        <div>
            ...
            >
                <ModalContent>
                    <>
                        <ModalHeader className="flex flex-col gap-1">Добавить магазин</ModalHeader>
                        <ModalBody>
                            <div>
                            ...
                            <div>
                                <p className="font-semibold text-start text-sm text-gray-500">
                                    Введите данные для входа в <span className='text-danger'> личный кабинет продавца </span> KASPI
                                </p>
                            </div>
