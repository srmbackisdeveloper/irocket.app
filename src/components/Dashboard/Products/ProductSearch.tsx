         ...
         <div className="p-3">
                  ...
                  >
                     {labeledData.map((data) => (
                        <SelectItem
                           key={data.value}
                           value={data.value}
                           onChange={() => handleSizeChange(data.value)}
                        >
                           {data.label}
                        </SelectItem>
                     ))}
            ...
            <div className="flex items-center gap-3 pt-5 pb-2">
               ...
               <label className="inline-block">
                  ...
                  <div
                     className={`inline-flex items-center px-3 py-1 rounded-full cursor-pointer duration-300 ease-in ${isChecked ? 'bg-danger text-white border border-transparent' : 'border border-gray-300 text-gray-700'}`}
                  >
